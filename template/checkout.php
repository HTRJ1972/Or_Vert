...
<!-- Mirrored from html.vecurosoft.com/farmix/demo/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Nov 2024 23:33:55 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container">
          ...
          <form action="#" class="woocommerce-cart-form">
            <table class="cart_table mb-20">
              ...
              <tbody>
                <tr class="cart_item">
                  <td data-title="Product"><a class="cart-productimage" href="shop.html"><img width="91" height="91" src="assets/img/product/product-1-1.png" alt="Image"></a></td>
                  <td data-title="Name"><a class="cart-productname" href="shop.html">Coconut Oil Jar</a>
                  </td>
            ...
            <div class="woocommerce-checkout-payment">
              <ul class="wc_payment_methods payment_methods methods">
                ...
                <li class="wc_payment_method payment_method_cod"><input id="payment_method_cod" type="radio" class="input-radio" name="payment_method"> <label for="payment_method_cod">Credit Cart
                    <img src="assets/img/product/credit-payment.png" alt="image"></label>
