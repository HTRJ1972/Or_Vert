...
// function recup_article(){
    ...
    $ch = curl_init();
    curl_setopt($ch,CURLOPT_URL, 'https://akila.blog/api/articles_n');
...
function recup_detail_post($mat_post){
    ...
    //-- verifie si les informtion recupé ne sont pas vide  return  $obj[0]
    if (isset($obj)) {
        return $obj[0];
        // var_dump($produits[0]->nom_art);
    }else{
